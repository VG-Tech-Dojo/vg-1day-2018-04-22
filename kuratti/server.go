...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/kuratti/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/kuratti/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/kuratti/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	// tutorial. 自己紹介を追加する
s.Engine.GET("/kuratti", func(c *gin.Context) {
                c.HTML(http.StatusOK, "kuratti.html", gin.H{})
        })
	// ...
