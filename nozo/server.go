...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/nozo/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/nozo/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/nozo/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/nozo", func(c *gin.Context) {
		c.HTML(http.StatusOK, "nozo.html", gin.H{})
	})
