...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/to-hutohu/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/to-hutohu/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	// tutorial. 自己紹介を追加する
	s.Engine.GET("/to-hutohu", func(c *gin.Context) {
		c.HTML(http.StatusOK, "to-hutohu.html", gin.H{})
	})
