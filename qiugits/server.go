...
import (
  ...
  "github.com/VG-Tech-Dojo/vg-1day-2018-04-22/qiugits/bot"
  "github.com/VG-Tech-Dojo/vg-1day-2018-04-22/qiugits/controller"
  "github.com/VG-Tech-Dojo/vg-1day-2018-04-22/qiugits/db"
  "github.com/VG-Tech-Dojo/vg-1day-2018-04-22/qiugits/model"
...
func (s *Server) Init(dbconf, env string) error {
  ...
  s.Engine.GET("/qiugits", func(c *gin.Context) {
    c.HTML(http.StatusOK, "qiugits.html", gin.H{})
  })
