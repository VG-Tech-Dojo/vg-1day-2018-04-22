...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/ninja/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/ninja/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/ninja/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	// tutorial. 自己紹介を追加する
	// ...
  s.Engine.GET("/ninja", func(c *gin.Context) {
		c.HTML(http.StatusOK, "ninja.html", gin.H{})
	})
	// api
