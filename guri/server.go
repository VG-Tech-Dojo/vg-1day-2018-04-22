...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/guri/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/guri/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/guri/db"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/guri/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	// tutorial. 自己紹介を追加する
	s.Engine.GET("/guri", func(c *gin.Context) {
		c.HTML(http.StatusOK, "guri.html", gin.H{})
	})
