...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/ihaya/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/ihaya/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/ihaya/db"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/ihaya/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/ihaya",  func(c *gin.Context) {
				c.HTML(http.StatusOK,  "ihaya_index.html",  gin.H{})
