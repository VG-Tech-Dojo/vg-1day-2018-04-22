...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/mottei/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/mottei/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/mottei/db"
	"github.com/VG-Tech-Dojo/vg-1day-2018-04-22/mottei/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	// tutorial. 自己紹介を追加する
	s.Engine.GET("/mottei", func(c *gin.Context) {
		c.HTML(http.StatusOK, "index.html", gin.H{})
	})
	// ...
